	...
	var ms = $.mobiscroll,
		...
		preset = function(inst) {
			...
			var s = $.extend({}, defaults, html5def, inst.settings),
				...
				stepM = s.stepMinute,
				stepS = s.stepSecond,
				mind = s.minDate || (s.minDateStr ? new Date(parseInt(s.minDateStr)) : false) || new Date(s.startYear, 0, 1),
				maxd = s.maxDate || (s.maxDateStr ? new Date(parseInt(s.maxDateStr)) : false) || new Date(s.endYear, 11, 31, 23, 59, 59);
